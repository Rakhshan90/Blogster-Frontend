    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          {/* success message  */}
          {passwordToken && (<h1 className="text-center text-green-700 text-lg">Email Successfully sent to your email address. Check your email inbox to reset your password</h1>)}
